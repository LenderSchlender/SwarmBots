...
\subsubsection{Technische Daten}
\begin{figure}[H]
    \includegraphics[width=0.7\textwidth, center]{img/Hardware/Motortreiber.png}
\end{figure}
...
\subsubsection{Technische Daten}
\begin{figure}[H]
    \includegraphics[width=0.7\textwidth, center]{img/Hardware/Ams1117.png}
\end{figure}
...
\subsubsection{Technische Daten}
\begin{figure}[H]
    \includegraphics[width=0.7\textwidth, center]{img/Hardware/hc06.png}
\end{figure}
...
\subsubsection{Technische Daten}
\begin{figure}[H]
    \includegraphics[width=0.7\textwidth, center]{img/Hardware/arduino_nano.png}
\end{figure}
...
\subsubsection{Technische Daten}
\begin{figure}[H]
    \includegraphics[width=0.7\textwidth, center]{img/Hardware/Infrarot_Sensor.png}
\end{figure}
...
\subsubsection{Technische Daten}
\begin{figure}[H]
    \includegraphics[width=0.7\textwidth, center]{img/Hardware/gleichstrommotor.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=0.7\textwidth, center]{img/Hardware/Gleichstromotor_innen.png}
    \caption{}
\end{figure}
%
\subsection{Encoder}
...
\subsubsection{Technische Daten}
\begin{figure}[H]
    \includegraphics[width=0.7\textwidth, center]{img/Hardware/encoder.png}
\end{figure}
