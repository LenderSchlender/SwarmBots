...
während der Arduino Nano ESP32 nur 3.3V Logic Level verwendet und nicht 5V-tolerant ist.
Wodurch dann einige Modifikationen nötig waren, siehe Abschnitt \ref{subsec:hardware_modifikationen}.
\begin{figure}[H]
...
% ETODO der ganze Absatz muss neu strukturiert werden????
...
dass der Strom von der Stromquelle als auch die Siganle,
zu allen Bauteilen auf der Platine verteilt werden
und dabei so EMV sicher wie möglich sind.
%
...
\begin{sidewaysfigure}
    ...
    \caption{Originaler Schaltplan des Tumbllers (ETODO: neu zeichnen)}
