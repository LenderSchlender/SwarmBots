...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.17\textwidth,page=1,angle=-90]{img/Projektbalkenplan-gantt_landscape.pdf}
    \caption{Projektbalkenplan01}
    \label{fig:psp_balk}
\end{figure}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.17\textwidth,page=2,angle=-90]{img/Projektbalkenplan-gantt_landscape.pdf}
