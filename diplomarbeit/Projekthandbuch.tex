...
\begin{center}
\textbf{Erich Erker (ProjektauftraggeberIn) \hspace{2cm} Mihael Stojkovic (ProjektleiterIn)}
\end{center}
...
\subsection{Projektarbeitspaketspezifikation}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{img/PSP_Balkenplan.png}
    \label{fig:psp_balk}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{img/Projektbalkenplan.png}
    \caption{Projektbalkenplan}
    \label{fig:psp_projektbalk}
\end{figure}
\newpage
